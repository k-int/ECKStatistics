			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="code" title="${message(code: 'module.code.label', default: 'Code')}" />
				...
				<g:each in="${moduleInstanceList}" status="i" var="moduleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${moduleInstance.id}">${fieldValue(bean: moduleInstance, field: "code")}</g:link></td>
