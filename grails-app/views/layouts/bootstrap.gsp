  ...
  <body>
    ...
    <nav class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${createLink(uri: '/')}">ECKStatistics</a>
    ...
    <div class="container">
      ...
      <footer>
        ...
        <span><b>Europeana Inside ECK Statistics</b> <i>Simplifying the supply of resources to Europeana and other Aggregators</i></span>
      </footer>
    </div>
