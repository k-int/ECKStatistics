...
<html>
	...
	<body>
		...
		totalNumberOfItemsProcessed: ${totalNumberOfItemsProcessed}<br/>
		totalTimeTakenToProcessTheItems: ${totalTimeTakenToProcessTheItems}<br/>
		FastestTimeToProcessAnItem: ${FastestTimeToProcessAnItem}<br/>
		SlowestTimeToProcessAnItem: ${SlowestTimeToProcessAnItem}<br/>
		AverageTimeTakenToProcessTheItems: ${AverageTimeTakenToProcessTheItems}<br/>
		moduleStatisticInstanceTotal: ${moduleStatisticInstanceTotal}<br/>
		totalTimeTakenToProcessTheItems: ${totalTimeTakenToProcessTheItems}<br/>
